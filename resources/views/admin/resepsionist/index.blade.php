							...
							<div class="col-xs-12 col-sm-12 col-md-3 col-lg-3">
								<div class="panel panel-default">
									...
									<div class="panel-body">
										<div class="form-group">
											<label></label>
											<img src="{{ URL::to('images/user-loket.jpg') }}" class="img-thumbnail" width="200px" height="200px" id="showPhoto">
											<input type="file" class="form-control" id="photo" name="photo" value="{{ URL::to('images/user-loket.jpg') }}">
										</div>
									</div>
								</div>
							</div>
